            ...
            <form action="{{ route('refund_ticket_entry') }}" method="post">
                ...
                <div class="grid grid-cols-2 gap-x-14">
                    ...
                    <div class="mb-4 flex items-center justify-between gap-6">
                        ...
                        <input type="text" class="form-input mt-1 block text-sm w-[65%] border p-1" readonly id="name" name="name" required>
                    </div>
                    <div class="mb-4 flex items-center justify-between gap-6">
                        <label for="sector" class="block text-md font-semibold text-black ">Sector</label>
                        <input type="tel" class="form-input mt-1 block text-sm w-[65%] border p-1" readonly id="sector" name="sector" required>
                    </div>
                    <div class="mb-4 flex items-center justify-between gap-6">
                        <label for="flight" class="block text-md font-semibold text-black ">Flight No</label>
                        <input type="text" class="form-input mt-1 block text-sm w-[65%] border p-1" readonly id="flight" name="flight" required>
                    </div>
                    <div class="mb-4 flex items-center justify-between gap-6">
                        <label for="flight_date" class="block text-md font-semibold text-black ">Flight Date</label>
                        <input type="date" class="form-input mt-1 block text-sm w-[65%] border p-1" readonly id="flight_date" name="flight_date" required>
                    </div>
                    <div class="mb-4 flex items-center justify-between gap-6">
                    ...
                    <div class="mb-4 flex items-center justify-between gap-6">
                        ...
                        <input type="text" class="form-input mt-1 block text-sm w-[65%] border p-1" readonly id="agent"  required>
                    ...
                    <div class="mb-4 flex items-center justify-between gap-6">
                        ...
                        <input type="text" class="form-input mt-1 block text-sm w-[65%] border p-1" id="supplier" required>
                    ...
                    <div class="mb-4 flex items-center justify-between gap-6">
                        ...
                        <input type="text" class="form-input mt-1 block text-sm w-[65%] border p-1" readonly id="agent_fare" name="agent_fare" required>
                    </div>
                    <div class="mb-4 flex items-center justify-between gap-6">
                        <label for="supplier_fare" class="block text-md font-semibold text-black ">Supplier Fare</label>
                        <input type="text" class="form-input mt-1 block text-sm w-[65%] border p-1" readonly id="supplier_fare" name="supplier_fare" required>
                    </div>
                    <div class="mb-4 flex items-center justify-between gap-6">
