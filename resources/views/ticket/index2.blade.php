    ...
    <div class="flex flex-col justify-center items-center p-6 rounded-lg shadow-md lg:w-3/4 w-full mx-auto my-2">
        ...
        <form class="w-full" id="ticket_form">
            ...
            <div class="flex flex-wrap gap-x-6 mb-4">
                ...
                <div class="w-full md:w-[48%] px-4 mb-2 flex items-center">
                    <label for="agent_name" class="block w-full md:w-[40%]  text-gray-700 text-sm mb-2">Agent
                        Name</label>
            ...
            <div class="flex flex-wrap gap-x-6 -mx-4 mb-4">
                ...
                <div class="w-full md:w-[48%] px-4 mb-2 flex items-center">
                    <label for="flight_date" class="block w-full md:w-[40%]  text-gray-700 text-sm mb-2">Flight
                        Date</label>
            ...
            <div class="flex flex-wrap gap-x-6 -mx-4 mb-4">
                <div class="w-full md:w-[48%] px-4 mb-2 flex items-center">
                    <label for="ticket_no" class="block w-full md:w-[40%]  text-gray-700 text-sm mb-2">Ticket No /
                        PNR</label>
                ...
                <div class="w-full md:w-[48%] px-4 mb-2 flex items-center">
                    <label for="number_of_tickets" class="block w-full md:w-[40%]  text-gray-700 text-sm mb-2">Number of
                        Tickets</label>
        ...
        <tbody>
            ...
            @foreach ($tickets as $ticket)
                <tr class="border-b hover:bg-gray-50">
                    ...
                    <td class="px-4 py-2 text-gray-700">{{ $ticket->airline_code }}-{{ $ticket->airline_name }}</td>
